Решено совместно с ментором:
  - Подгружать списки топиков для каждого стрима одновременно с загрузкой всех стримов;
  - Для чата первоначально подгружать из апи 50 сообщений и кэшировать их. Затем уже подгружать порциями по 20 
