...
internal var messages = mutableListOf(
    ...
    Message(
        ...
        userId = 2,
        topicName = "Testing",
        content = "Не следует, однако, забывать о том, что социально-экономическое развитие способствует подготовке и реализации ключевых компонентов планируемого обновления.",
        reactions = listOf(
            Reaction(1, "👍"),
            Reaction(2, "👍"),
            Reaction(2, "😌"),
    ...
    Message(
        ...
        userId = 1,
        topicName = "Testing",
        content = "Like the technical community as a whole, the Zulip team and community is made up of a mixture of professionals and volunteers from all over the world, working on every aspect of the mission, including mentorship, teaching, and connecting people.\n" +
                "\n" +
